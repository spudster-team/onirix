    ...
    return (
        <main className='iir' ref={parentRef}>
            ...
            <article>
                ...
                <img src={hostname + "/assets/about_iir.png"}  className='animate__animated animate__slideInLeft' alt="research-lab" />
            </article>
            <article  className='animate__animated animate__slideInRight'>
                <img src={hostname + "/assets/about_iir3.jpg"} alt="sleeping-woman" className='animate__animated animate__slideInRight'  />
            ...
            <article>
                ...
                <img src={hostname + "/assets/about_iir2.png"} id="img-recherche" alt="working-coder" className='display-none' />
            </article>
        </main>
    )
}
