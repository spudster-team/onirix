...
const Iir = ({hostname}) => {
    return (
        <main className='iir'>
            <h1>Institut International des Rêves (IIR) </h1>
            <article>
                <div>
                ...
                <img src={hostname + "/assets/about_iir.png"} alt="research-lab" />
            </article>
            <article>
                <img src={hostname + "/assets/about_iir3.jpg"} alt="sleeping-woman" />
                <div>
            ...
            <article>
                ...
                <img src={hostname + "/assets/about_iir2.png"} alt="working-coder" />
            </article>
        </main>
    )
}
