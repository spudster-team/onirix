        ...
        <main className='about' ref={parentRef}>
            <section>
                ...
                <article className='info info-left animate__animated animate__slideInRight'>
                    ...
                    <img src="/assets/abstract_patterns/ap2.png" alt="" />
                </article>
                <article className='info info-right animate__animated animate__slideInLeft'>
                    <img src="/assets/abstract_patterns/ap3.png" alt="" />
                    <div>
                ...
                <article className='info info-left animate__animated animate__slideInRight'>
                    ...
                    <img src="/assets/abstract_patterns/ap4.png" alt="" />
                </article>
                <article className='info info-right'>
                    <img src="/assets/abstract_patterns/ap5.png" id="img-fiable" className='display-none' alt="" />
