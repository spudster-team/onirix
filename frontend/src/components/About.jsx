        ...
        <main className='about' ref={parentRef}>
            <section>
                ...
                <article className='info info-left animate__animated animate__slideInRight'>
                    ...
                    <img src={hostname + "/assets/abstract_patterns/ap2.png"} alt="sdfds" />
                </article>
                <article className='info info-right animate__animated animate__slideInLeft'>
                    <img src={hostname + "/assets/abstract_patterns/ap3.png"} alt="cx" />
                    <div>
                ...
                <article className='info info-left animate__animated animate__slideInRight'>
                    ...
                    <img src={hostname + "/assets/abstract_patterns/ap4.png"} alt="sdjfjkd" />
                </article>
                <article className='info info-right'>
                    <img src={hostname + "/assets/abstract_patterns/ap5.png"} id="img-fiable" className='display-none' alt="" />
